...
export class AdminScreenComponent implements OnInit{
  ...
  constructor(
    ...
    //mat dialog es para los modales
  ...
  public delete(idUser: number){
    const dialogRef = this.dialog.open(EliminarUserModalComponent,{
      ...
      height: '288px',//aqui se ajusta el tamado del modal en altura y anchura dependiendo de lo que busquemos
      width: '328px',
    });

    dialogRef.afterClosed().subscribe(result => {
      if(result.isDelete){ // si se borro imprime eliminado
